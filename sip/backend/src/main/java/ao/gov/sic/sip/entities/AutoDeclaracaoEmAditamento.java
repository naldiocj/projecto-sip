...
@Entity
@Table(name = "autos_declaracoes_em_aditamentos")
@Setter
@Getter
@Builder
@NoArgsConstructor
@AllArgsConstructor
@SQLDelete(sql = "UPDATE autos_declaracoes_em_aditamentos SET is_deleted = true WHERE id=?")
@SQLRestriction("is_deleted=false")
public class AutoDeclaracaoEmAditamento {
    @Id
